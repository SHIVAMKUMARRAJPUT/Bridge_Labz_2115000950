...
class Test4{
    public static void Print(){
        ...
        inventory.AddItemAtBeginning(123, "Laptop", 5, 1200);
        inventory.AddItemAtEnd(154, "Mouse", 10, 25);
        inventory.AddItemAtEnd(142, "Keyboard", 7, 50);
        inventory.AddItemAtPosition(172, "Monitor", 3, 300, 2);
        ...
        Console.WriteLine("\nUpdating Quantity:");
        inventory.UpdateQuantity(154, 15);
